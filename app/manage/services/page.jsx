                ...
                <table className="min-w-full bg-white border-collapse border border-gray-200 shadow-md">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-slate-900">Title English</th>
                            <th className="border border-gray-300 px-4 py-2 text-slate-900">Title Sinhala</th>
                            <th className="border border-gray-300 px-4 py-2 text-slate-900">Title Tamil</th>
